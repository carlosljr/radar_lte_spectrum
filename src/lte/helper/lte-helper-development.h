...
//Inserção: Carlos --> Inserindo biblioteca AggregateInterference DsaMechanisms.
...
public:
  ...
  */
  ...
  //Inserção: Carlos --> Declarando método para setar mobilidade do radar.

  void SetRadarMobility (NodeContainer radar);

  void SetStartTime (Time t, Ptr<LteEnbNetDevice> dev);
...
private:
 ...
 //Inserção --> Carlos
  ...
  ObjectFactory m_radarFactory;
  ObjectFactory m_dsaFactory;
  ...
  //Declarando objeto do tipo AggregateInterference.

  Ptr<AggregateInterference> m_agg;

  //Inserção: Carlos --> Declarando objeto do tipo DsaMechanisms.

  Ptr<DsaMechanisms> m_dsa;

  //Inserção: Carlos --> Declarando booleano para uso ou não do espectro do Radar.

  bool m_radarSpectrum;

  //Inserção: Carlos --> Declarando ponteiro para MobilityModel do radar.

  Ptr<MobilityModel> m_radarMobility;
