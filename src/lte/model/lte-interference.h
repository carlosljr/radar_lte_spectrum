...
//Inserção: Carlos --> adicionando biblioteca;
...
public:
  ...
  //Declarando função para criar o radar na classe Interference
  void SetRadar(Ptr<radar> r);
  bool GetLoss ();
...
private:
  ...
  //Inserção: Carlos --> Declarando ponteiro do tipo radar.

  Ptr<radar> m_radar;

  Ptr<SpectrumValue> m_int_radar;
