...
//Inserção Carlos:Inserindo .h radar

#include "ns3/radar-module.h"

//Inserção: Carlos -> Biblioteca AggregateInterference.
...
public:
  ...
  //Inserção: Carlos -> Declarando método que chama objeto Radar para se associar ao objeto AggregateInterference.

  void SetAggregateInterference (Ptr<AggregateInterference> agg);

  //Inserção: Carlos -> Retorna objeto AggregateInterference.

  Ptr<AggregateInterference> GetAgg ();

 //Inserção: Carlos -> Declarando método para retirar interferência do radar.

  void EndRadarInterf ();

 //Inserção: Carlos -> Declarando método para inserir interferência no radar.

  void AddSUInterference (Time dur, Time del);

  void SetPropagationDelay (Ptr<PropagationDelayModel> prop); 
...
//Inserçâo: Carlos --> Declarando método para aprovisionamento do objeto radar.
...
private:
  ...
  //Inserção Carlos --> Declarando ponteiro tipo radar
